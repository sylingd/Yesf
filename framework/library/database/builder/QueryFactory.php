...
class QueryFactory
{
    ...
    {
        $queryClass = "yesf\library\database\builder\\{$this->db}\\{$query}";
        if ($this->common) {
            $queryClass = "yesf\library\database\builder\Common\\{$query}";
        }

        $builderClass = "yesf\library\database\builder\\{$this->db}\\{$query}Builder";
        if ($this->common || ! class_exists($builderClass)) {
            $builderClass = "yesf\library\database\builder\Common\\{$query}Builder";
        }
    ...
    {
        $quoterClass = "yesf\library\database\builder\\{$this->db}\Quoter";
        if (! class_exists($quoterClass)) {
            $quoterClass = "yesf\library\database\builder\Common\Quoter";
        }
